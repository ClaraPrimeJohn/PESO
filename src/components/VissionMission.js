...
import bgImage from "../assets/about-6.png"; // Update the path to your image
...
const VisionMission = () => {
  return (
    <motion.div
      id="vision-mission"
      className="relative bg-cover bg-center bg-no-repeat py-16 px-6 sm:px-8 md:px-10 mb-10"
    ...
    {/* Card Container */}
<motion.div
  className="grid mt-10 grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 px-4"
