  ...
  return (
    <PageLoader>
      <div className="flex flex-col min-h-screen">
        <div className="flex-grow mx-4 sm:mx-8 md:mx-16 lg:mx-32 xl:mx-48 py-8 my-4">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="lg:w-3/4">
              ...
              {loading ? (
                ...
                <>
                  {currentAnnouncements.length > 0 ? (
                    <div className={`space-y-6 ${currentAnnouncements.length <= 2 ? 'mb-16' : ''}`}>
                      {currentAnnouncements.map((announcement) => (
                        <div
                          key={announcement.id}
                          className="bg-white shadow-sm border rounded-lg overflow-hidden transition-transform transform hover:-translate-y-1 hover:shadow-md duration-300 ease-out"
                        >
              ...
              {!loading && filteredAnnouncements.length > 0 && (
                <div className={filteredAnnouncements.length <= 2 ? 'mt-16' : 'mt-8'}>
                  <PaginationControls />
                </div>
              )}

              
              {filteredAnnouncements.length <= 1 && <div className="py-24"></div>}
            </div>
          </div>
        </div>
      </div>
